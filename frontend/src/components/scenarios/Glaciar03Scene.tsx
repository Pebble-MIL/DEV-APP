...
export default function Glaciar03Scene({ foundClues, onClueFound }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 600 400" className="w-full h-full">
      ...
      <text x="200" y="80" textAnchor="middle" fill="white" fontSize="14" fontFamily="monospace" fontWeight="bold">Bienvenidos!</text>
      <text x="200" y="105" textAnchor="middle" fill="#82cfff" fontSize="12" fontFamily="monospace">Clase: 4° Básico</text>
      <text x="200" y="125" textAnchor="middle" fill="#82cfff" fontSize="10" fontFamily="monospace">Profesora: Martina</text>
      ...
      {!found1 ? (
        <g onClick={() => onClueFound?.('glaciar_03_clue_1')} className="cursor-pointer">
          ...
          <text x="430" y="68" textAnchor="middle" fill="#006389" fontSize="8" fontFamily="monospace" fontWeight="bold">HORARIO</text>
          <text x="390" y="82" fill="#0d1d2b" fontSize="7" fontFamily="monospace">Lun: 8:00-15:00</text>
          <text x="390" y="94" fill="#0d1d2b" fontSize="7" fontFamily="monospace">Mar: 8:00-15:00</text>
          <text x="390" y="106" fill="#0d1d2b" fontSize="7" fontFamily="monospace">Mie: 8:00-13:00</text>
          <text x="390" y="118" fill="#0d1d2b" fontSize="7" fontFamily="monospace">Jue: 8:00-15:00</text>
          <text x="390" y="130" fill="#0d1d2b" fontSize="7" fontFamily="monospace">Vie: 8:00-13:00</text>
        ...
        <g>
          ...
          <text x="430" y="95" textAnchor="middle" fill="white" fontSize="10">🚫 Horario!</text>
        </g>
      )}
      ...
      {!found2 ? (
        ...
        <g>
          ...
          <text x="220" y="265" textAnchor="middle" fill="white" fontSize="12">🚫 Amigos visibles</text>
        </g>
      )}

      {/* Found badges */}
      {found1 && (
        <text x="430" y="145" textAnchor="middle" fill="#097dac" fontSize="9" fontWeight="bold">🕐 Horario visible!</text>
      )}
      {found2 && (
        <text x="220" y="310" textAnchor="middle" fill="#097dac" fontSize="9" fontWeight="bold">👥 Tus amigos también salen!</text>
      )}
    </svg>
  )
}
